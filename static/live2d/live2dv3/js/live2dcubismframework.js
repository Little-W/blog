            ...
            this.parameterTracks.forEach(function (t) {
             if(track_enabled){
                ...
                if(t.targetId == "PARAM_ANGLE_X" ||t.targetId == "PARAM_ANGLE_Y" || t.targetId == "PARAM_EYE_BALL_X" || t.targetId == "PARAM_EYE_BALL_Y" || 
                  t.targetId == "PARAM_BODY_ANGLE_X" ||t.targetId == "PARAM_BODY_ANGLE_Y" || t.targetId == "PARAM_BODY_ANGLE_Z" || t.targetId == "PARAM_BODY_ANGLE_WAVE" || 
                    t.targetId == "ParamAngleX" || t.targetId == "ParamAngleY" || t.targetId == "ParamAngleZ" || t.targetId == "ParamEyeBallX" || t.targetId == "ParamEyeBallY" 
					||t.targetId == "ParamBodyAngleX"  ||t.targetId == "ParamBodyAngleY" ||t.targetId == "Param_BodyAngle_Y" ||t.targetId == "Param_BodyAngle_Y" ){ return; }
            }
