              ...
              _createClass(QualitySelector, [
                  ...
                  value: function onQualitySelect(quality) {
                    ...
                    if (this.sources) {
                      ...
                      if (source) {
                        ...
                        var sources = this.player.currentSources(),
                        currentTime = this.player.currentTime(),
                        isPaused = this.player.paused(),
                        currentpost = this.player.poster_;
                    ...
                    //sources[0].src =  source.src;
                    sources[0].selected = true;
            
                    if (this.player._qualitySelectorSafeSeek) {
                        this.player._qualitySelectorSafeSeek.onQualitySelectionChange();
                    }
                    this.player.poster(null);
                    this.player.src(sources);
                    var video_element = document.getElementById("mv_player_html5_api");
                    video_element.setAttribute("src",source.src);
                    this.player.ready(function() {
                        ...
                        if (!isPaused) {
                          ...
                          Array.from(
                            _this.containerDropdownElement.firstChild.childNodes
                        ...
                        //_this.player.poster(currentpost);
                        ...
                        //     _this.player.currentTime(current_time);
                        //   _this.player.play();
                      ...
                      var qualitySelector = player.getElementsByClassName(
                ...
                },
                {
                  ...
                  value: function onToggleDropdown() {
                    if (
                      this.containerDropdownElement.className.indexOf(
                        "show"
                      ) === -1
                    ) {
                      ...
                      var className =
                        this.containerDropdownElement.className.replace(
                          " show",
                          ""
                        );
                ...
                },
                {
                  ...
                  value: function onPlayerReady(options) {
                    ...
                    this.containerDropdownElement =
                      document.createElement("div");
                    this.containerDropdownElement.className =
                      "vjs-quality-dropdown";
                      var former_div = this.player.controlBar.el_.querySelector(".vjs-quality-container");
                      try {
                        this.player.controlBar.el_.removeChild(former_div);
                      } catch (err) {
                        //console.error(err)
                      }
                    ...
                    button_div.setAttribute("class","vjs-quality-button");
                    buttonElement.innerText = options.text || "1080p";

                    button_div.appendChild(buttonElement);
                    button_div.onclick = function (e) {
                      return _this2.onToggleDropdown(e);
                    };
                    ...
                    containerElement.appendChild(button_div);

                    var pictureInPictureToggle =
                      this.player.controlBar.pictureInPictureToggle.el();

                    this.player.controlBar
                      .el()
                      .insertBefore(containerElement, pictureInPictureToggle);
            ...
            var qualityselector = function qualityselector(options) {
              ...
              this.ready(function () {
                ...
                qualityControl.onPlayerReady(
                  _videoJs2["default"].mergeOptions(
                    qualityControl.defaults,
                    options
                  )
                );
              });
