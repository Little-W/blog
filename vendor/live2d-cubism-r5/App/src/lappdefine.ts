...
// 相対パス
export const ResourcesPath = '/live2d/live2dv3/assets/';

// シェーダー相対パス
export const ShaderPath = '/live2d/cubism-r5/shaders/WebGL/';
...
// 外部定義ファイル（json）と合わせる
export const MotionGroupIdle = ''; // yikesi 模型将全部动作保存在默认组
